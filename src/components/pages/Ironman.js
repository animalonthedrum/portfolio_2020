...
const Ironman = () =>{
    return (
        ...
        <List>
        <li>A keyword race search which is filterable, weighted, editable and pulls the most up to date data from their API.</li>
        ...
        <p>There are some stunning components throughout the site that really make this an elite design. The site features desktop animations, a mega-menu/ghost navigation, graphic elements to highlight their great photography and modern article design to support their content creation goals.This project was marked by a high level of detail, pioneering functionality, complex change management, unique stakeholder engagement, and training and documentation.</p>
        <p>Designed by <a href="https://www.linkedin.com/in/robin-marquardt-51750184" target="_blank"  rel="noopener noreferrer">Robin Marquadt </a></p>
         <p>Technologies: JS/jQuery, GSAP, SCSS, AJAX, API, Site Builder (SportsEngine’s proprietary CMS)</p>
         </motion.div>
        </Layout>
    )
}
